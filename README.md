...
- **[whisperX](https://github.com/m-bain/whisperX)**: Whisper와 wav2vec2 강제 정렬(Forced Alignment)을 결합하여 정밀한 단어 레벨 타임스탬프를 획득하는 파이프라인 설계의 주요 영감을 제공한 프로젝트입니다.
- **[whisper.cpp](https://github.com/ggml-org/whisper.cpp)**: C/C++ 기반의 고성능 Whisper 추론 엔진 및 프리빌트 모듈의 기반 프로젝트입니다.
- **[onnxruntime](https://github.com/microsoft/onnxruntime)**: wav2vec2 모델의 효율적인 CPU/GPU 추론을 가능케 하는 고성능 엔진입니다.
- **[GTCRN](https://github.com/545907361/GTCRN)**: 배경 소음 및 음악 제거를 통한 음성 향상(Denoising) 처리에 활용된 신경망 모델입니다.
- **[wav2vec 2.0](https://arxiv.org/abs/2006.11477)**: 단어 정렬 단계의 특징 추출 및 CTC emission 계산에 활용되는 음성 표상 학습 프레임워크입니다.
