...
const ko = {
  ...
  // 모델 관리
  'settings.models': '모델 관리',
  'settings.models.openFolder': '모델 폴더 열기',
  'settings.models.download': '다운로드',
  'settings.models.cancel': '취소',
  'settings.models.delete': '삭제',
  'settings.models.installed': '설치됨',
  'settings.models.downloading': '{pct}%',
  'settings.models.notDownloadable': '수동 설치',
  'settings.models.error': '실패'
} as const
...
const en: Messages = {
  ...
  'settings.models.downloading': '{pct}%',
  'settings.models.notDownloadable': 'Manual install',
  'settings.models.error': 'Failed'
}
...
const ja: Messages = {
  ...
  // モデル管理
  'settings.models': 'モデル管理',
  'settings.models.openFolder': 'モデルフォルダを開く',
  'settings.models.download': 'ダウンロード',
  'settings.models.cancel': 'キャンセル',
  'settings.models.delete': '削除',
  'settings.models.installed': 'インストール済み',
  'settings.models.downloading': '{pct}%',
  'settings.models.notDownloadable': '手動インストール',
  'settings.models.error': '失敗'
}
...
const es: Messages = {
  ...
  // Gestión de modelos
  'settings.models': 'Gestión de modelos',
  'settings.models.openFolder': 'Abrir carpeta de modelos',
  'settings.models.download': 'Descargar',
  'settings.models.cancel': 'Cancelar',
  'settings.models.delete': 'Eliminar',
  'settings.models.installed': 'Instalado',
  'settings.models.downloading': '{pct}%',
  'settings.models.notDownloadable': 'Instalación manual',
  'settings.models.error': 'Error'
}
...
const fr: Messages = {
  ...
  // Gestion des modèles
  'settings.models': 'Gestion des modèles',
  'settings.models.openFolder': 'Ouvrir le dossier des modèles',
  'settings.models.download': 'Télécharger',
  'settings.models.cancel': 'Annuler',
  'settings.models.delete': 'Supprimer',
  'settings.models.installed': 'Installé',
  'settings.models.downloading': '{pct}%',
  'settings.models.notDownloadable': 'Installation manuelle',
  'settings.models.error': 'Échec'
}
...
const de: Messages = {
  ...
  // Modellverwaltung
  'settings.models': 'Modellverwaltung',
  'settings.models.openFolder': 'Modellordner öffnen',
  'settings.models.download': 'Herunterladen',
  'settings.models.cancel': 'Abbrechen',
  'settings.models.delete': 'Löschen',
  'settings.models.installed': 'Installiert',
  'settings.models.downloading': '{pct}%',
  'settings.models.notDownloadable': 'Manuelle Installation',
  'settings.models.error': 'Fehler'
}
...
const zhHans: Messages = {
  ...
  'settings.models.openFolder': '打开模型文件夹',
  'settings.models.download': '下载',
  'settings.models.cancel': '取消',
  'settings.models.delete': '删除',
  'settings.models.installed': '已安装',
  'settings.models.downloading': '{pct}%',
  'settings.models.notDownloadable': '手动安装',
  'settings.models.error': '失败'
}
...
const zhHant: Messages = {
  ...
  // 模型管理
  'settings.models': '模型管理',
  'settings.models.openFolder': '開啟模型資料夾',
  'settings.models.download': '下載',
  'settings.models.cancel': '取消',
  'settings.models.delete': '刪除',
  'settings.models.installed': '已安裝',
  'settings.models.downloading': '{pct}%',
  'settings.models.notDownloadable': '手動安裝',
  'settings.models.error': '失敗'
}
